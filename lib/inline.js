...
InlineCompiler.prototype = {
  ...
  tryEm: function(walk) {
    return this.tryBracing(walk, '_', '_', emitEm) || this.tryBracing(walk, '*', '*', emitEm);
  ...
  tryStrong: function(walk) {
    return this.tryBracing(walk, '**', '**', emitStrong) || this.tryBracing(walk, '__', '__', emitStrong);

    function emitStrong(w) {
